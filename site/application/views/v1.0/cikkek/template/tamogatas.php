<div class="tamogatas-form-holder">
  <div class="header">
    <h2>Támogatás küldése</h2>
  </div>
  <div class="cwrapper">
    <form id="tamogatasform" action="" method="post">
    <div class="group">
      <h3>1. Adomány adatai</h3>
      ...
      <div class="paying" style="display:none;" id="payingbuttons_OTPSimple">
        <div class="text">
          <div class="t">
            ...
            <br>
            <a href="http://simplepartner.hu/PaymentService/Fizetesi_tajekoztato.pdf" target="_blank"> <img height="30" src="/wp-content/themes/Divi/moduls/tamogatas/simplesdk/logos/simplepay_bankcard_logos_left_482x40.png" title=" SimplePay - Online bankkártyás fi zetés" alt=" SimplePay vásárlói tájékoztató"></a>
          </div>
        </div>
        <div class="buttons">
          ...
          <div class="t" style="border-left: 5px solid #009b7b; padding: 0 10px;">
            ...
            <table>
              <tr>
                ...
                <td><strong>Értéktárs Közösség Alapítvány</strong></td>
              </tr>
              <tr>
                <td>Számlaszám</td>
                <td><strong>16200137 - 18541337</strong></td>
              </tr>
              <tr>
                <td>Bank</td>
                <td><strong>MAGNET Bank Zrt.</strong></td>
              </tr>
              <tr>
                <td>SWIFT</td>
                <td><strong>HBWEHUHB</strong></td>
              </tr>
            </table>
  ...
  <script type="text/javascript">
    ...
    function selectPayingMode( mode ) {
      ...
      if (mode != '') {
        jQuery.post(
          "<?=admin_url( 'admin-ajax.php' )?>?action=tamogatas_form", {
            mode: mode,
