    	...
    	<div class="con con-row-list">
            ...
            <div class="row np deep<?=$news['deep']?> markarow  <?=($this->news && $this->gets[1] == 'szerkeszt' && $this->news->getId() == $news['ID'] ? 'on-edit' : '')?> <?=($this->news && $this->gets[1] == 'torles' && $this->news->getId() == $news['ID'] ? 'on-del' : '')?>">
            	<div class="col-md-5">
                  ...
                  <div class="subline"><a target="_blank" class="url" href="<?=HOMEDOMAIN?>esemeny/<?=$news['eleres']?>" class="news-url"><i title="<?=HOMEDOMAIN?>" class="fa fa-home"></i>/esemeny/<strong><?=$news[eleres]?></strong></a></div>
                </div>
                <div class="col-md-2 center">
