...
$config = [
    ...
    //HUF
    'HUF_MERCHANT' => "S522501", //merchant account ID (HUF)
    'HUF_SECRET_KEY' => "mGTwmw4bjcR3kPQpKT55ugBDXD6Pc3p7Ba17TowzwEg=", //secret key for account ID (HUF)
    //EUR
    ...
    'SANDBOX' => true,
    //common return URL
    'URL' => 'http://' . $_SERVER['HTTP_HOST'] . '/gateway/simple',
